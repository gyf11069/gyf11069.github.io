...
if [ -z "$GITHUB_TOKEN" ]; then
  msg='deploy'
  githubUrl=git@github.com:gyf11069/gyf11069.github.io.git
else
  msg='来自 Github actions 的自动部署'
  githubUrl=https://gyf11069:${GITHUB_TOKEN}@github.com/gyf11069/gyf11069.github.io.git
  git config --global user.name "gyf11069"
  git config --global user.email "1224254097@qq.com"
fi
git init
git add -A
git commit -m "${msg}"
