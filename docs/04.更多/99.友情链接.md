...
与我[ 联系 ](/about/#联系)发送您的友链信息，格式：(点击代码块右上角一键复制)

```yaml
- name: 莫哈德的博客 # 昵称
  desc: 纸上得来终觉浅，绝知此事要躬行。 # 介绍
  avatar: https://github.com/gyf11069/gyf11069.github.io/blob/main/docs/.vuepress/public/img/tx1.jpg?raw=true # 头像地址
  link: https://gyf11069.github.io/ # 链接
```
